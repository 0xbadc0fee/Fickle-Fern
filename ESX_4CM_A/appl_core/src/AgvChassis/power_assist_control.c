...
sint16 init_powerAssistControl(T_UserInterface *_ui, T_Config_PowerAssistControl *_nvmPAControl)
{
    sint16 s16_error = C_NO_ERR;
       ...
       if((_ui == NULL) || (_nvmPAControl == NULL))
       {
           return C_WARN;
       }
...
sint16 update_powerAssistControl(void)
{
    sint16 s16_error = C_NO_ERR;
       ...
       //getHighGearEnable(&u8_high_gear_status); //TODO_STW Add getter HIGH GEAR ENABLE
       ...
       if(mt_power_assist.pu8_power_assist_led_status != NULL)
       {
           *(mt_power_assist.pu8_power_assist_led_status) =
               ...
               ((mt_power_assist.u8_power_assist_status == POWER_ASSIST_ENABLED) &&
                (mt_power_assist.pt_nvm_pa_control->u8_power_assist_installed == TRUE)) ? 0x10u :
               ((mt_power_assist.u8_power_assist_status == POWER_ASSIST_DISABLED) &&
                (mt_power_assist.pt_nvm_pa_control->u8_power_assist_installed == TRUE)) ? 0x01u :
               0x01u;
       }
       else
       {
