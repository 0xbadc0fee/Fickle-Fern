 ...
 */
sint16 init_headerControl(T_CANDevices *_can_devs, T_Config_HeaderControl *_nvmHeaderControl)
{
    sint16 s16_error = C_NO_ERR;

    //populate local copy of TX ui elements
    mt_hdr_control.pu8_relief_swich = &_can_devs->t_display.u8_relief_switch_status;

    //populate local copy of RX ui elements
    mt_hdr_control.pu8_joy_lift_header = &_can_devs->t_joystick.u8_b5_state;
    mt_hdr_control.pu8_joy_lift_header = &_can_devs->t_joystick.u8_b6_state;
