...
sint16 init_coolingFanControl(T_CANDevices *_can_devs, T_ChkPoints_CoolingFan *_chkCoolingFan)
{
    ...
    /*TODO_STW
    mt_cooling_fan.pf32_engine_coolant_temp_degC  = &_ui->t_engine.f32_engine_coolant_temp_degC;
    mt_cooling_fan.pf32_intake_manifold_temp_degC = &_ui->t_engine.f32_intake_manifold_temp_degC;
     */
    mt_cooling_fan.pu8_manual_purge_req          = &_can_devs->t_display.u8_manual_purge_req;
    mt_cooling_fan.pu16_disp_hyd_oil_temp_degC   = &_can_devs->t_display.u16_hyd_oil_temp_degC;
    mt_cooling_fan.pu8_disp_fan_reverse_ind      = &_can_devs->t_display.u8_cooling_fan_reverse_ind;
    mt_cooling_fan.pu8_disp_cooling_system_fault = &_can_devs->t_display.u8_cooling_system_fault;
    mt_cooling_fan.pu8_disp_hyd_oil_overtemp     = &_can_devs->t_display.u8_hyd_oil_overtemp;
    mt_cooling_fan.pu8_disp_intake_overtemp      = &_can_devs->t_display.u8_intake_manifold_overtemp;
    mt_cooling_fan.pu8_disp_coolant_overtemp     = &_can_devs->t_display.u8_engine_coolant_overtemp;
