...
static T_osy_non_existing_type_2521518294 mt_Variable;
#endif

///ensure file consistency (if compilation fails here the .h file does not match this .c file)
CONFIGURATION_PROJECT_ID_2521518294
...
{
   {
      ...
      1300U,   ///< max_curr_fwd (Parameter description)
      200U,   ///< min_curr_fwd (Parameter description)
      1300U,   ///< max_curr_rev (Parameter description)
      200U,   ///< min_curr_rev (Parameter description)
