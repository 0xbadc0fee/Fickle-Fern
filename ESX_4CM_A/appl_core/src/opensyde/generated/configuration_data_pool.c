...
static T_osy_non_existing_type_3361031019 mt_Variable;
#endif

///ensure file consistency (if compilation fails here the .h file does not match this .c file)
CONFIGURATION_PROJECT_ID_3361031019
...
static const T_osy_dpa_list_definition mat_DataPoolLists[CONFIGURATION_NUMBER_OF_LISTS] =
{
   ...
   { CONFIGURATION_POWERASSISTCONFIG_NUMBER_OF_ELEMENTS, CONFIGURATION_POWERASSISTCONFIG_NUMBER_OF_DATA_SETS, 0U, 0x00000065U, sizeof(T_Configuration_PowerAssistConfig_Values), &mat_DataPoolPowerAssistConfigElements[0], &gt_Configuration_DataPoolValues.t_PowerAssistConfigValues, NULL }
};
...
static const T_osy_dpa_data_pool_definition mt_DataPoolDefinition =
{
   ...
   0x4d965a5eU, ///< CRC of Datapool definition
