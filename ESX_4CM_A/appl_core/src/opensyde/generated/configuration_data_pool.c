...
static T_osy_non_existing_type_1169636876 mt_Variable;
#endif

///ensure file consistency (if compilation fails here the .h file does not match this .c file)
CONFIGURATION_PROJECT_ID_1169636876
...
static const T_osy_dpa_list_definition mat_DataPoolLists[CONFIGURATION_NUMBER_OF_LISTS] =
{
   ...
   { CONFIGURATION_STICKBOXCONFIG_NUMBER_OF_ELEMENTS, CONFIGURATION_STICKBOXCONFIG_NUMBER_OF_DATA_SETS, 0U, 0x00000065U, sizeof(T_Configuration_StickBoxConfig_Values), &mat_DataPoolStickBoxConfigElements[0], &gt_Configuration_DataPoolValues.t_StickBoxConfigValues, NULL }
};
