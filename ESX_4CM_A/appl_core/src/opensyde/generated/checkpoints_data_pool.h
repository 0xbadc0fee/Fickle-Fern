...
#define CHECKPOINTS_LIST_INDEX_HEADERCONTROL (1U)
#define CHECKPOINTS_LIST_INDEX_GENERALTESTING (2U)
#define CHECKPOINTS_NUMBER_OF_LISTS (3U)
...
#define CHECKPOINTS_ELEM_INDEX_HEADERCONTROL_CHECKPOINT1 (0U)
#define CHECKPOINTS_ELEM_INDEX_HEADERCONTROL_CHECKPOINT2 (1U)
#define CHECKPOINTS_ELEM_INDEX_HEADERCONTROL_CHECKPOINT3 (2U)
#define CHECKPOINTS_HEADERCONTROL_NUMBER_OF_ELEMENTS (3U)
...
#define CHECKPOINTS_HEADERCONTROL_NUMBER_OF_DATA_SETS (0U)
...
#define CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT1 (1.0F)
#define CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT1 (0.0F)
#define CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT2 (1.0F)
#define CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT2 (0.0F)
#define CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT3 (1.0F)
#define CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT3 (0.0F)
...
#define CHECKPOINTS_SET_VALUE_FROM_SCALED_HEADERCONTROL_CHECKPOINT1(SCALED_VALUE) (gt_Checkpoints_DataPoolValues.t_HeaderControlValues.u8_checkpoint1 = (SCALED_VALUE - CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT1) / CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT1)
#define CHECKPOINTS_GET_SCALED_VALUE_HEADERCONTROL_CHECKPOINT1() ((gt_Checkpoints_DataPoolValues.t_HeaderControlValues.u8_checkpoint1 * CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT1) + CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT1)
#define CHECKPOINTS_SET_VALUE_FROM_SCALED_HEADERCONTROL_CHECKPOINT2(SCALED_VALUE) (gt_Checkpoints_DataPoolValues.t_HeaderControlValues.s16_checkpoint2 = (SCALED_VALUE - CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT2) / CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT2)
#define CHECKPOINTS_GET_SCALED_VALUE_HEADERCONTROL_CHECKPOINT2() ((gt_Checkpoints_DataPoolValues.t_HeaderControlValues.s16_checkpoint2 * CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT2) + CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT2)
#define CHECKPOINTS_SET_VALUE_FROM_SCALED_HEADERCONTROL_CHECKPOINT3(SCALED_VALUE) (gt_Checkpoints_DataPoolValues.t_HeaderControlValues.f32_checkpoint3 = (SCALED_VALUE - CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT3) / CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT3)
#define CHECKPOINTS_GET_SCALED_VALUE_HEADERCONTROL_CHECKPOINT3() ((gt_Checkpoints_DataPoolValues.t_HeaderControlValues.f32_checkpoint3 * CHECKPOINTS_SCALING_FACTOR_HEADERCONTROL_CHECKPOINT3) + CHECKPOINTS_SCALING_OFFSET_HEADERCONTROL_CHECKPOINT3)
...
typedef struct
{
   ...
   sint16 s16_checkpoint2; /* Variable description */
   float32 f32_checkpoint3; /* Variable description */
} T_Checkpoints_HeaderControl_Values;
...
typedef struct
{
   ...
   T_Checkpoints_HeaderControl_Values t_HeaderControlValues;
